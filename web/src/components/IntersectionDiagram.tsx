...
export default function IntersectionDiagram({
  ...
  return (
    <div
      className={`rounded-lg border border-line bg-bg px-4 py-8 sm:px-8 ${className}`}
    >
      <div
        role="img"
      ...
      >
        <span
          aria-hidden="true"
          className="flex h-[min(10rem,38vw)] w-[min(10rem,38vw)] items-center justify-center rounded-full border border-brand/30 bg-brand/10 pr-[min(3rem,11vw)] sm:h-[min(14rem,26vw)] sm:w-[min(14rem,26vw)] sm:pr-[min(4rem,7vw)]"
        >
        ...
        <span
          aria-hidden="true"
          className="-ml-[min(3.5rem,13vw)] flex h-[min(10rem,38vw)] w-[min(10rem,38vw)] items-center justify-center rounded-full border border-accent-violet/30 bg-accent-violet/10 pl-[min(3rem,11vw)] sm:-ml-[min(5rem,9vw)] sm:h-[min(14rem,26vw)] sm:w-[min(14rem,26vw)] sm:pl-[min(4rem,7vw)]"
        >
        ...
        <span
          aria-hidden="true"
          className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-1 rounded-xl border border-ok/30 bg-bg px-2.5 py-2 sm:px-3"
        >
      ...
      <ul className="mx-auto mt-8 grid max-w-3xl gap-3 sm:grid-cols-3">
        {REGIONS.map((r) => (
          <li
            key={r.key}
            className="rounded-xl border border-line-soft bg-bg p-4"
          >
